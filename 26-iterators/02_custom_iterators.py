...
本模块展示如何创建自定义迭代器类，实现复杂的迭代逻辑。
通过实际例子学习迭代器的设计模式和最佳实践。
...
if __name__ == "__main__":
    print("\n=== 总结 ===")
    print("1. 自定义迭代器需要实现__iter__和__next__方法")
    print("2. 可重用迭代器应该在__iter__中返回新的迭代器实例")
    print("3. 迭代器可以实现复杂的遍历逻辑，如树遍历、批量处理等")
    print("4. 合理的状态管理是迭代器设计的关键")
    print("5. 迭代器模式提供了统一的遍历接口")